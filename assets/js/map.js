...
var land_type_matched_source = new ol.source.TileWMS({
    url: geoServerURL,
    params: {
        'LAYERS': ' fmb' + ':' + 'fmb_subdivision_link_ror'
    },
    serverType: 'geoserver'
});
...
var fmb_unmatched_source = new ol.source.TileWMS({
    url: geoServerURL,
    params: {
        'LAYERS': ' fmb' + ':' + 'fmb_subdivision_not_link_ror'
    },
    serverType: 'geoserver'
});
...
var land_type_matched_wmts_source = new ol.source.WMTS({
    url: wmts_url,
    layer:'fmb:fmb_subdivision_link_ror',
    matrixSet: 'EPSG:4326',
    format: 'image/png',
    projection: projection,
    tileGrid: new ol.tilegrid.WMTS({
        ...
        resolutions: resolutions,
        matrixIds: matrixIds,
        extent: [76.88282012939453, 8.212702751159668,80.24774169921875, 13.353839874267578]
    })
});
...
var land_type_unmatched_wmts_source = new ol.source.WMTS({
    url: wmts_url,
    layer:'fmb:fmb_subdivision_not_link_ror',
    matrixSet: 'EPSG:4326',
    format: 'image/png',
    projection: projection,
    tileGrid: new ol.tilegrid.WMTS({
        ...
        resolutions: resolutions,
        matrixIds: matrixIds,
        extent: [76.89379119873047, 8.206770896911621, 80.2461929321289, 13.354781150817871]
    })
});
...
// full survey match with ror
var full_survey_matched_source = new ol.source.TileWMS({
    url: geoServerURL,
    params: {
        'LAYERS': ' fmb' + ':' + 'cadastral_link_ror'
    },
    serverType: 'geoserver'
});
var full_survey_matched = new ol.layer.Tile({
    title: 'Matched with roro',
    type: 'wms',
    source: full_survey_matched_source,
    name: "cadastral_link_ror",
    visible: false,
    displayInLayerSwitcher: false,
});
map.addLayer(full_survey_matched);
//full survey wmts
var full_survey_wmts_source = new ol.source.WMTS({
    url: wmts_url,
    layer:'fmb:cadastral_link_ror',
    matrixSet: 'EPSG:4326',
    format: 'image/png',
    projection: projection,
    tileGrid: new ol.tilegrid.WMTS({
        ...
        resolutions: resolutions,
        matrixIds: matrixIds,
        extent: [76.88617706298828, 8.23779582977295,80.24713134765625, 13.347107887268066]
    })
});
var full_survey_match_wmts = new ol.layer.Tile({
    title: 'Full Survey Link ror',
    source: full_survey_wmts_source,
    name: "cadastral_link_ror_wmts",
    visible: false,
    displayInLayerSwitcher: false,
});
map.addLayer(full_survey_match_wmts);

// full survey unmatch with ror
var full_survey_unmatched_source = new ol.source.TileWMS({
    url: geoServerURL,
    params: {
        'LAYERS': ' fmb' + ':' + 'cadastral_not_link_ror'
    },
    serverType: 'geoserver'
});
var full_survey_unmatched = new ol.layer.Tile({
    title: 'UnMatched with roro',
    type: 'wms',
    source: full_survey_unmatched_source,
    name: "cadastral_not_link_ror",
    visible: false,
    displayInLayerSwitcher: false,
});
map.addLayer(full_survey_unmatched);
//full survey wmts
var full_survey_unmatch_wmts_source = new ol.source.WMTS({
    url: wmts_url,
    layer:'fmb:cadastral_not_link_ror',
    matrixSet: 'EPSG:4326',
    format: 'image/png',
    projection: projection,
    tileGrid: new ol.tilegrid.WMTS({
        ...
        resolutions: resolutions,
        matrixIds: matrixIds,
        extent: [76.8828125, 8.206075668334961,80.24889373779297, 13.354840278625488]
    })
});
var full_survey_unmatch_wmts = new ol.layer.Tile({
    title: 'Full Survey not Link ror',
    source: full_survey_unmatch_wmts_source,
    name: "cadastral_not_link_ror_wmts",
    visible: false,
    displayInLayerSwitcher: false,
});
map.addLayer(full_survey_unmatch_wmts);
...
var with_tn_code_source = new ol.source.TileWMS({
    url: geoServerURL,
    params: {
        'LAYERS': ' fmb' + ':' + 'with_tamil_nillam_code',
        'STYLES': '',
    },
    serverType: 'geoserver'
});
...
var with_tamil_nillam_code_wmts_source = new ol.source.WMTS({
    url: wmts_url,
    layer:'fmb:with_tamil_nillam_code',
    matrixSet: 'EPSG:4326',
    format: 'image/png',
    projection: projection,
    tileGrid: new ol.tilegrid.WMTS({
...
var no_tn_code_source = new ol.source.TileWMS({
    url: geoServerURL,
    params: {
        'LAYERS': ' fmb' + ':' + 'no_tamil_nillam_code',
        'STYLES': '',
    },
    serverType: 'geoserver'
});
...
var others_tn_code_source = new ol.source.TileWMS({
    url: geoServerURL,
    params: {
        'LAYERS': ' fmb' + ':' + 'others_tamil_nillam_code',
        'STYLES': '',
    },
    serverType: 'geoserver'
});
